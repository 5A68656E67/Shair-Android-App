...
public class TransactionAdapter extends ArrayAdapter<Notification> {
    public TransactionAdapter(Context context, ArrayList<Notification> users) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
       ...
       //     viewHolder.time = (TextView) convertView.findViewById(R.id.notification_time);
        ...
        viewHolder.tvinfo.setText(notification.getNeederName() + " got your item " + notification.getItemName() );
    //    viewHolder.time.setText(notification.getTimeStamp());
